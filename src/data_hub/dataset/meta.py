...
class MetaFactory:
    ...
    @staticmethod
    def get_dataset_meta(identifier: str = None, dataset_name: str = None, dataset_tag: str = None, iterator_meta: IteratorMeta = None) -> DatasetMeta:
    ...
    @staticmethod
    def get_dataset_meta_from_existing(dataset_meta: DatasetMeta, identifier: str = None, dataset_name: str = None, dataset_tag: str = None) -> DatasetMeta:
