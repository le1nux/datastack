...
class TestReporting:
    ...
    def test_plain_iterator_reporting(self, mnist_factory):
        ...
        dataset_meta = MetaFactory.get_dataset_meta(identifier="id x", dataset_name="MNIST", dataset_tag="train", iterator_meta=iterator_meta)
    ...
    def test_combined_iterator_reporting(self, mnist_factory):
        ...
        meta_train = MetaFactory.get_dataset_meta(identifier="id x", dataset_name="MNIST", dataset_tag="train", iterator_meta=iterator_train_meta)
        meta_test = MetaFactory.get_dataset_meta(identifier="id x", dataset_name="MNIST", dataset_tag="train", iterator_meta=iterator_test_meta)
